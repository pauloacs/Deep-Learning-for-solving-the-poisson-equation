...
def gen_blockMeshDict(x_cord, y_cord):
    ...
    f.write("    hex (1 0 4 3 9 8  12 11) ({} {} {}) simpleGrading (1 1 1)\n".format(150 - x_cell, y_cell, 1))
    f.write(");\n"
            "\n"
            "edges\n"
            "(\n"
...
parser.add_argument("x_cord", help="X coordinate of backward step")
parser.add_argument("y_cord", help="Y coordinate of backward step")
