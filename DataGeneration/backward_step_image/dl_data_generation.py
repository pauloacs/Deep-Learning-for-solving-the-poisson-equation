...
def gen_matrix(array=None):
    ...
    rect_4 = np.zeros((Y[2], X[0])) - 1.0 #obstaculo

    con_1 = np.concatenate((rect_1, rect_2), axis=1)
    con_2 = np.concatenate((rect_4, rect_3), axis=1)
...
train_shape = (total_sim, 21, 50, 150, 4)
