...
def gen_blockMeshDict(r_int, y_max):
    ...
    r_int = r_int
    r_ext = 2 * r_int
    x_cell = int(r_int * scale_for_cells*2)
    x_cell2 = int( (xmax - r_ext) * scale_for_cells*2)
    x_cell3 = int( ( abs(xmin) - r_ext ) * scale_for_cells*2)
    y_cell = int(r_int * scale_for_cells*2)
    y_cell2 = int( (ymax - r_ext) * scale_for_cells*2)
    ...
    f.write(");\n"
            ...
            "blocks\n"
            "(\n")
    f.write("    hex (5 4 9 10 24 23 28 29) ({} {} {}) simpleGrading (1 1 1)\n".format(x_cell, y_cell, 1))
    f.write("    hex (0 1 4 5 19 20 23 24) ({} {} {}) simpleGrading (1 1 1)\n".format(x_cell, y_cell, 1))
    f.write("    hex (1 2 3 4 20 21 22 23) ({} {} {}) simpleGrading (1 1 1)\n".format(x_cell2 , y_cell, 1))
    f.write("    hex (4 3 6 7 23 22 25 26) ({} {} {}) simpleGrading (1 1 1)\n".format(x_cell2, y_cell2, 1))
    f.write("    hex (9 4 7 8 28 23 26 27) ({} {} {}) simpleGrading (1 1 1)\n".format(x_cell, y_cell2, 1))
    f.write("    hex (15 16 10 9 34 35 29 28) ({} {} {}) simpleGrading (1 1 1)\n".format(x_cell, y_cell, 1))
    f.write("    hex (12 11 16 15 31 30 35 34) ({} {} {}) simpleGrading (1 1 1)\n".format(x_cell, y_cell, 1))
    f.write("    hex (13 12 15 14 32 31 34 33) ({} {} {}) simpleGrading (1 1 1)\n".format(x_cell3, y_cell, 1))
    f.write("    hex (14 15 18 17 33 34 37 36) ({} {} {}) simpleGrading (1 1 1)\n".format(x_cell3, y_cell2, 1))
    f.write("    hex  (15 9 8 18 34 28 27 37) ({} {} {}) simpleGrading (1 1 1)\n".format(x_cell, y_cell2, 1))
